...
/**
 * The "WELCOME TO FUSION" hero. On the landing view it fills the screen with a
 * CTA; once the user enters, it shrinks to a slim accent column beside the form.
 * Ported verbatim from the operator console.
 */
    ...
    >
      {isLogin && (
        <Box
          ...
          style={{
            position: "absolute",
            right: 0, top: "10%", bottom: "10%", width: 4,
            background:
