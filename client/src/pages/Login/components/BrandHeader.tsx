...
/**
 * Top bar: institute logo + name, and today's date.
 *
 * Identical to the operator console's header except for `tag`, which is the one
 * thing that should differ — whoever is looking at this needs to know which
 * surface they are on.
 */
export default function BrandHeader({ isMobile, date, tag }: {
  isMobile: boolean;
  date: string;
  tag: string;
}) {
